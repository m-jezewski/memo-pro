        ...
        isOpen ?
            <div onClick={(e) => { e.target !== modalRef.current && setIsOpen(false) }}
                ...
                <div
                    ...
                    ref={modalRef}
                    className='relative bg-gradient-to-b from-dark_blue_1 to-slate-900 p-10 
                    rounded-3xl flex flex-col gap-8 items-center text-white_1 
                    shadow-[0px_0px_60px_-5px_rgba(0,0,0,0.50)] max-w-sm w-screen max-h-screen m-8 custom-scrollbar overflow-y-auto scroll'>
